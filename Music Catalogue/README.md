...
<p>A Music Cataloging website for keeping track of one's music. The user can save the details of their music to a Postgres database, where they can also update, delete, and search for them. There is also a feature for users to develop their playlists with the site or have a random song for them to listen to.</p>
